...
<template>
  <app-layout>
    ...
    <template #footer>
      <div class="footer">
        <p>Contacts:</p>
        <a target="_blank" href="https://github.com/frontandrew/tree-grid">
          <svg viewBox="0.5 0.5 22.8 22.8">
            <path
        ...
        <a target="_blank" href="https://t.me/frontandrew">
          <svg viewBox="-10 -10 530 530">
            <path
