...
.theme-toggler {
  ...
  .theme-toggler-icon {
    ...
    g path {
      ...
      transition: transform calc(var(--toggle-theme-duration) * 0.65)
        cubic-bezier(0, 0, 0, 1.25) calc(var(--toggle-theme-duration) * 0.35);
    }
